...
const EventCreatedModal: FC<Props> = ({ isPublished, event, eventLink, child }) => {
  const { hasCopied, onCopy } = useClipboard(eventLink as string)
  return (
    <Modal
      isOpen={isPublished as boolean}
      onClose={() => {
        console.log("")
      }}
    >
      ...
      <ModalContent rounded="2xl">
        <ModalBody textAlign="center">
          <Image src="/assets/elements/sparkle_3.svg" alt="sparkle" w="28" mx="auto" h="28" />
          ...
          <Flex mx="auto" mt="2" justify="center" align="center">
            <Box
              p="2"
              bg="white"
            ...
            <Button
              ...
              leftIcon={
                <Box
                  ...
                  transitionDuration="200ms"
                >
                  <Image src="/assets/elements/event_ticket_gradient.svg" w="4" alt="ticket" />
                </Box>
              }
              _focus={{}}
              _active={{}}
