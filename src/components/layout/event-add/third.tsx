  ...
  return (
    ...
    >
      <Box color="brand.black">
        <Text align="center" color="brand.black400" fontSize="4xl" fontWeight="semibold" mt="12">
          Add Image/Video to your event page
        </Text>

        <Flex justify="space-between" gridGap="14" mt="6" px="10" maxW="1400px" mx="auto">
          <Box fontFamily="body" w="full">
                  ...
                  >
                    {({ getRootProps, getInputProps }) => (
                      ...
                      >
                        ...
                        <>
                          <Image src="/assets/elements/images.svg" alt="images" w="8" />
                          <Button
                            _hover={{
                              bg: "blackAlpha.50",
                            }}
            ...
            <FormControl mt="8" _focusWithin={{ borderBottomColor: "gray.300" }}>
              ...
              <FormLabel
                ...
                pb="4"
              >
                Add a video about your event. If added, it’ll appear as the first item in the
                gallery
              </FormLabel>
              <InputGroup>
                <Input
