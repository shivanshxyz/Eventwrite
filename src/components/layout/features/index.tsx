        ...
        <>
            <Flex flexDir={"column"} justifyContent="center" alignItems="center" gap="10" bgColor={"#d3b1b138"} m="20" pb={10} pt={10} rounded={"xl"}>
                ...
                <Flex justifyContent="space-evenly" w="full" wrap="wrap" gap="10">
                    <FeatureCard heading="Simple Event Ticketing" content={sampleText1} image="./image/floatCube.gif"/>
                    <FeatureCard heading="Sample Heading" content={sampleText2} image="./image/floatCube.gif"/>
                    <FeatureCard heading="Sample Heading" content={sampleText3} image="./image/floatCube.gif"/>
                </Flex>
            </Flex>
        </>
    )
